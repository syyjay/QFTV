...
// MARK:- 定义协议
@objc protocol SUBContentViewDelegate : class {
    func contentView(_ contentView : SUBContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : SUBContentView)
}
...
class SUBContentView: UIView{
    ...
    // MARK: 对外属性
    weak var delegate : SUBContentViewDelegate?
...
extension SUBContentView : UICollectionViewDataSource {
...
extension SUBContentView : UICollectionViewDelegate {
